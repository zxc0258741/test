...
imglist=get_imlist('/home/lcw/下載/tensorflow/hourse')
...
def main():
  ...
  for imgpath in imglist[:]: 
    ...
    style = sum(map(lambda l: build_style(sess.run(net[l[0]]) ,  net[l[0]],'/home/lcw/下載/tensorflow/hoursepool5/'+imgpath.split('/')[6].split('.')[0]), STYLE_LAYERS))
